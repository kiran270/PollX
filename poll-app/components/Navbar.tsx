...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 h-screen w-56 ${bgClass} border-r ${borderClass} flex flex-col z-50 transition-transform duration-300 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
        } lg:left-0`}>
        {/* Logo - Desktop Only */}
        ...
        <div className={`p-4 border-t ${borderClass}`}>
          {isLoading ? (
            ...
            <button
              onClick={() => signIn("google")}
              className="w-full px-3 py-2 bg-[#E31E24] hover:bg-[#C41A1F] text-white text-sm font-medium rounded-lg transition-colors flex items-center justify-center gap-2 whitespace-nowrap"
            >
